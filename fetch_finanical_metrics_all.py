...
def fetch_and_transform_financials(ticker):
    ...
    final_columns = ['Ticker Symbol', 'Company Name', 'Industry', 'Sector', 'Year'] + [col for col in merged_df.columns if col not in ['Ticker Symbol', 'Company Name', 'Industry', 'Sector', 'Year']]
